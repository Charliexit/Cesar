...
if wget -q https://github.com/Charliexit/Cesar/raw/master/musicSH/"$random_mp3"; then
...
echo -e "\033[1;35m"
git clone https://github.com/Charliexit/Cesar.git
